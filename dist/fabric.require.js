...
(function() {
    ...
    fabric.util.object.extend(fabric.Canvas.prototype, {
        ...
        _onScale: function(e, transform, x, y) {
            var target = transform.target, whichHandle = target.__corner, isCorner = whichHandle === "tr" || whichHandle === "tl" || whichHandle === "br" || whichHandle === "bl", lockUniScalingOnCorners = target.get("lockUniScalingOnCorners"), shouldScaleEqualy = false;
...
fabric.util.object.extend(fabric.IText.prototype, {
    ...
    getSelectionStartFromPointer: function(e) {
        var mouseOffset = this._getLocalRotatedPointer(e), textLines = this.text.split(this._reNewline), prevWidth = 0, width = 0, height = 0, charIndex = 0;
        for (var i = 0, len = textLines.length; i < len; i++) {
...
fabric.util.object.extend(fabric.IText.prototype, {
    initHiddenTextarea: function(x, y) {
        var userAgent = navigator && navigator.userAgent ? navigator && navigator.userAgent.toLowerCase() : "", looksLikeiPad = userAgent.indexOf("ipad") !== -1, looksLikeAndroidChrome = userAgent.indexOf("chrome") !== -1 && userAgent.indexOf("android") !== -1;
    ...
    getCharactersToInsert: function(originalText, newText) {
        var i, j, idxFirstDifference = -1, idxLastSameOnNew = -1, numSameOnEnd = 0, newCandidate, newOriginal;
